...
var fetchFligthsArrivalsPromise = _jquery2.default.getJSON('http://apis.is/flight?language=en&type=arrivals');

var fetchFlightsDeparturesPromise = _jquery2.default.getJSON('http://apis.is/flight?language=en&type=departures');
...
function renderContentTo(domEl, theRoute) {
  ...
  if (theRoute === 'flights') {
    ...
    _jquery2.default.when(fetchFligthsArrivalsPromise, fetchFlightsDeparturesPromise).then(function (serverResArrivals, serverResDepartures) {
