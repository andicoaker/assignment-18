...
var fetchConcertsPromise = _jquery2.default.getJSON('http://apis.is/concerts').then(function (serverRes) {
  console.log(serverRes);
});

var fectchCarpoolsPromise = _jquery2.default.getJSON('http://apis.is/rides/samferda-drivers/').then(function (serverRes) {
  console.log(serverRes);
});

var fetchFlightsDeparturesPromise = _jquery2.default.getJSON('http://apis.is/flight?language=en&type=departures').then(function (serverRes) {
  console.log(serverRes);
});

var fetchFligthsArrivalsPromise = _jquery2.default.getJSON('http://apis.is/flight?language=en&type=arrivals').then(function (serverRes) {
  console.log(serverRes);
});
